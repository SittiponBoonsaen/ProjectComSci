(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["partofpage-addfield-addfield-module"], {
    ...
    function aih(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".avatar-pic {\n  width: 150px;\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    function X4gS(module, __webpack_exports__, __webpack_require__) {
      ...
      var AddfieldPage = /*#__PURE__*/function () {
        function AddfieldPage(camera, alertController, router, datapassService, Http) {
        ...
        _createClass(AddfieldPage, [{
          ...
          value: function addfield() {
            ...
            this.Http.post('http://localhost:5000/apiFinal/field/add', JSON.stringify(dataJSON)).subscribe(function (data) {
              console.log(data);
            });
          }
        }, {
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            var navigate = _this.router.navigate(['/home/tabs/account/managestore/managefield']);
                          }
                        }, {
                          text: 'ไม่',
                          role: 'cancel',
